...
{
    public partial class frmAP_PaymentHistoryReport : System.Web.UI.Page
    {
        clsAP_PaymentHistory PaymentHistory = new clsAP_PaymentHistory();
        ...
        private void PrintPaymentHistory()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                PaymentHistory = new clsAP_PaymentHistory();
                ReportDocument objReport = new ReportDocument();
                objReport = new Report.rptAP_PaymentHistory();
        ...
        private void LoadBranch()
        {
            ...
            MySqlDataReader dr = PaymentHistory.LoadBranch();
