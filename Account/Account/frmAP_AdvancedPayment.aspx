<%@ Page Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true"
    CodeBehind="frmAP_AdvancedPayment.aspx.cs" Inherits="Account.Account.frmAP_AdvancedPayment" %>
                    ...
                    <div class="col-lg-12">
                        <div class="widget ">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="controls col-lg-3">
                                                <label class="control-label" for="AdvancePaymentNo">
                                                    Advance Pay No</label>
                                            </div>
                                            <div class="controls col-lg-9">
                                                <asp:TextBox ID="txtAdvancePaymentNo" runat="server" class="form-control" MaxLength="11"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls col-lg-9">
                                                <asp:TextBox ID="txtAmount" runat="server" class="form-control" MaxLength="11" required></asp:TextBox>
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        <!-- /form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="controls col-lg-9">
                                                <asp:TextBox ID="txtAdvancedAmount" runat="server" class="form-control" MaxLength="11"
                                                    required></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls col-lg-9">
                                                <asp:TextBox ID="txtBalanceAmount" runat="server" class="form-control" MaxLength="11"
                                                    required></asp:TextBox>
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls col-lg-9">
                                                <asp:TextBox ID="txtRemark" runat="server" class="form-control" cols="40" name="txtRemark"
                                                    MaxLength="145"></asp:TextBox>
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        <!-- /form-group -->
                                ...
                                <div class="col-lg-12">
                                    <h4>
                                        Advance Paid Invoice Details</h4>
