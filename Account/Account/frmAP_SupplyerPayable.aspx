							    ...
							    <form id="frmSupplierPayable" action="#">
								    ...
								    <div class="control-group">											
									    ...
									    <div class="controls">
										    ...
										    <asp:TextBox ID="txtSupplier" class = "span4" runat="server"></asp:TextBox></div> <!-- /controls -->				
								    </div> <!-- /control-group -->										
								    <div class="control-group">											
								    ...
								    <div class="control-group">											
									    ...
									    <div class="controls">
										    <asp:TextBox ID="txtRemark" class="span4" runat="server"></asp:TextBox></div> <!-- /controls -->				
								    </div> <!-- /control-group -->		
